...
//choose 1 word from the array to be drawn
...
function draw() {
 ...
 //if the drawing and the sketch chosen is same 
 }
...
//display the sketch u are drawing
